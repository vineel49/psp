...
% Trellis for M = 2, L=2
function [P_State,P_State_trans,P_Ip,P_Ip_trans,Ga_Inx]= Get_Trellis()
P_State = [1,2;3,4;1,2;3,4]; % PREVIOUS STATES
P_State_trans =  [1,3,1,3;2,4,2,4]; % TRANSPOSE OF P_State
P_Ip = [1,1;1,1;2,2;2,2]; % Previous input matrix
P_Ip_trans = [1,1,2,2;1,1,2,2]; % transpose of the PREVIOUS INPUTS
